...
hist(glyco_c$coverage)
hist(glyco_h$height)
hist(glyco_h$log(height))
glyco_h$a <- log(height)
...
```{r}
boxplot(coverage~Outflow_Location,data=glyco_c, main="Car Milage Data",
   xlab="location", ylab="coverage")
boxplot(coverage~Region,data=glyco_c, main="Car Milage Data",
   xlab="location", ylab="coverage")
